...
class EnvEditor():
    def __init__(self):
        ...
        self.DESC_L1_MAINSTEM_INPUT = " filename for the generated general L1.txt file for PyFluxPro"
        self.INFO_L1_MAINSTEM_INPUT = "The control txt file for PyFluxPro's L1 process."
        self.BROWSE_L1_AMERIFLUX_ONLY_INPUT = " L1.txt file formatted for AmeriFlux"
        self.DESC_L1_AMERIFLUX_ONLY_INPUT = " filename for the generated L1.txt that meets AmeriFlux submission " \
                                            "standards."
        self.INFO_L1_AMERIFLUX_ONLY_INPUT = "The txt file that will be generated by the process with AmeriFlux " \
