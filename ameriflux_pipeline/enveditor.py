...
class EnvEditor():
    def __init__(self):
        ...
        self.BROWSE_L1_AMERIFLUX = " L1.txt file formatted for Ameriflux"
        self.DESC_L1_AMERIFLUX = " filename for the generated L1.txt that meets Ameriflux submission standards."
    ...
    def run(self):
        ...
        info_l1_input = tk.Button(second_frame, text=self.INFO_TITLE, font=self.MAIN_FONT,
                                  command=self.on_click_l1_input).grid(sticky="w", row=i+4, column=1)
        button_browse_l1_input = tk.Button(master=second_frame, text="Browse", font=self.MAIN_FONT,
        ...
        desc_l1_input = tk.Label(second_frame, text=self.DESC_L1_INPUT, font=self.DESC_FONT) \
            .grid(sticky="w", row=i+5, column=0, columnspan=3)
        self.path_l1_input = tk.Label(master=second_frame, text=self.L1_INPUT, font=self.MAIN_FONT)
        ...
        desc_l1_output = tk.Label(second_frame, text=self.DESC_L1_OUTPUT, font=self.DESC_FONT). \
            grid(sticky="w", row=i+17, column=0, columnspan=3)
