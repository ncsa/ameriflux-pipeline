...
class MetMergerGUI():
    def __init__(self):
        ...
        self.DESC_START_DATE = " start date for the output met data."
        self.INFO_START_DATE = "The date will be used as the start date for the output met data."

        # end date
        self.END_DATE_LOCAL_VALUE = ""
        self.LABEL_END_DATE = " Set end date"
        self.DESC_END_DATE = " end date for the output met data."
        self.INFO_END_DATE = "The date will be used as the end date for the output met data."
