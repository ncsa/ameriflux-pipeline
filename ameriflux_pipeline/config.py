...
class Config:
    ...
    # input met data path
    INPUT_MET = os.getenv('INPUT_MET', DATA_ROOT+'master_met/input/FLUXSB_EC_JanMar2021.csv')
    # input precip path
    INPUT_PRECIP = os.getenv('INPUT_PRECIP', DATA_ROOT+'master_met/input/Precip_IWS_Jan-Feb_2021.xlsx')
    ...
    MASTER_MET = os.getenv('MASTER_MET', DATA_ROOT+'master_met/output/met_output.csv')  # output data path

    # input data for formatting Eddypro master meteorology data
    INPUT_SOIL_KEY = os.getenv('INPUT_SOIL_KEY', DATA_ROOT+'eddypro/input/Soils_key.xlsx')  # input soil key data path
    ...
    EDDYPRO_PROJ_FILE_NAME = os.getenv('EDDYPRO_PROJ_FILE_NAME', DATA_ROOT+'eddypro/input/EddyPro_Run_Template.eddypro')
    ...
    FULL_OUTPUT_PYFLUXPRO = os.getenv('FULL_OUTPUT_PYFLUXPRO', DATA_ROOT+'pyfluxpro/input/full_output.csv')
    MET_DATA_30_PYFLUXPRO = os.getenv('MET_DATA_30_PYFLUXPRO', DATA_ROOT+'pyfluxpro/input/Met_data_30.csv')
    PYFLUXPRO_INPUT_SHEET = os.getenv('PYFLUXPRO_INPUT_SHEET', DATA_ROOT+'pyfluxpro/input/pyfluxpro_input.xlsx')
