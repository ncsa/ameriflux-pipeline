...
class Config:
    ...
    INPUT_PRECIP = os.getenv('INPUT_PRECIP', 'data/master_met/input/Precip_IWS_Jan-Feb_2021.xlsx')  # input precip path
    ...
    MASTER_MET = os.getenv('MASTER_MET', 'data/master_met/output/met_output.csv')  # output data path
