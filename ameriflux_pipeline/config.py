...
class Config:
    ...
    EDDYPRO_PROJ_FILE = os.getenv('EDDYPRO_PROJ_FILE', 'sample_test/2021-01-01T000000_Sorghum-00137.metadata')
    EDDYPRO_DYN_METADATA = os.getenv('EDDYPRO_DYN_METADATA', 'sample_test/Sorghum_2021_dynamic_metadata.csv')
    EDDYPRO_OUTPUT_PATH = os.getenv('EDDYPRO_OUTPUT_PATH', 'sample_test/test_output')
    EDDYPRO_INPUT_GHG_PATH = os.getenv('EDDYPRO_INPUT_GHG_PATH', 'sample_test/sample_ghg_files')
