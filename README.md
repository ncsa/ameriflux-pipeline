...
- Tested with EddyPro 7.0.9 and PyFluxPro 3.4.7 as well. However, if there is any problem in running eddypro or pyfluxpro, the versions stated above is highly recommended 
