...
def test_run_eddypro():
    ...
    eddypro_bin_loc = "C:\\Program Files\\LI-COR\\EddyPro-7.0.7\\bin"
    file_name = "C:\\Workspace-ameriflux\\ameriflux-pipeline\\ameriflux_pipeline\\templates\\EddyPro_Run_SB_ForNCSA.eddypro"
    project_title = "Project Title"
    project_id = "Project ID"
    ...
    dyn_metadata_file = "Sorghum_2021_dynamic_metadata.csv"
    ...
    biom_file = "C:\\Workspace-ameriflux\\ameriflux-pipeline\\tests\\data\\FLUXSB_EC_JanMar2021_output_eddypro.csv"
    ex_file = "/path/to/ex_file"  # eddypro_Efarm_Sorghum_Reanalysis_2020_fluxnet_2021-10-26T101711_adv.csv
