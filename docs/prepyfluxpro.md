...
### 8
- pre_processing() method first calls the [eddypro_preprocessing()](https://github.com/ncsa/ameriflux-pipeline/blob/develop/ameriflux_pipeline/pre_pyfluxpro.py#L78) method to create the master meteorological data and format it for eddypro input.
